...
export default class Response {
    ...
    notAlloud(errormessage = '') { return this.status(405, errormessage); }        // Method not aloud status
    ...
    blocked(errormessage = '') { return this.status(483, errormessage); }   // custom bad request status
